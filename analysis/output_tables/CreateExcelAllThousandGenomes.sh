...
-r Caco2=data/bundle/Caco2/Caco2.abc.sure.annot.bgz \
...
-r Caco2Stim=data/bundle/Caco2/Caco2.abc.sure.annot.bgz \
...
-r K562=data/bundle/K562/K562.abc.sure.annot.bgz \
...
-r Jurkat=data/bundle/Jurkat/Jurkat.abc.sure.annot.bgz \
...
-r JurkatStim=data/bundle/JurkatStim/JurkatStim.abc.sure.annot.bgz \
