...
k562.ttest  <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_K562_ttest_covar.assoc", qqman.compatible = F)
k562.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_K562_wilcox.assoc", qqman.compatible = F)
k562.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_INDEL_K562_wilcox.assoc", qqman.compatible = F)

Caco.ttest  <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_Caco_ttest_covar.assoc", qqman.compatible = F)
Caco.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_Caco_wilcox.assoc", qqman.compatible = F)
Caco.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_INDEL_Caco_wilcox.assoc", qqman.compatible = F)

CacoStim.ttest  <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_CacoStim_ttest_covar.assoc", qqman.compatible = F)
CacoStim.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_SNP_CacoStim_wilcox.assoc", qqman.compatible = F)
CacoStim.wilcox <- read.ase.results("output/summary_statistics/SuRE_CeD_INDEL_CacoStim_wilcox.assoc", qqman.compatible = F)
...
Caco.peakset     <- read.bedfile("../peakcalling/output/overlaps/CeD_C_B1_vs_B2_x3.bed")$genomicRanges
CacoStim.peakset <- read.bedfile("../peakcalling/output/overlaps/CeD_Cs_B1_vs_B2_x3.bed")$genomicRanges
k562.peakset     <- read.bedfile("../peakcalling/output/overlaps/CeD_Cs_B1_vs_B2_x3.bed")$genomicRanges


Caco.snps        <- GRanges(seqnames=paste0("chr", Caco.active[,1]),
                            ranges=IRanges(start=as.numeric(Caco.active[,2]),
                                           width=rep(1, nrow(Caco.active))))

CacoStim.snps    <- GRanges(seqnames=paste0("chr", CacoStim.active[,1]),
                            ranges=IRanges(start=as.numeric(CacoStim.active[,2]),
                                           width=rep(1, nrow(CacoStim.active))))


k562.snps        <- GRanges(seqnames=paste0("chr", k562.active[,1]),
                            ranges=IRanges(start=as.numeric(k562.active[,2]),
