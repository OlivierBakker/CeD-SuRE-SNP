...
public class AnnotatedIpcrRecordWithMate extends IpcrRecordWithMate {

    private List<GeneticVariant> overlappingVariants;
    private int invalidVariantAlleles;
    private int undeterminedVariantAlleles;

    public AnnotatedIpcrRecordWithMate(String barcode, SAMRecord cachedSamRecord, SAMRecord mate) {
    ...
    public AnnotatedIpcrRecordWithMate(String barcode, String referenceSequence, int startOne, int endOne, int startTwo, int endTwo, char orientation, int mapqOne, int mapqTwo, String cigarOne, String cigarTwo, String sequenceOne, String sequenceTwo, int duplicateCount) {
