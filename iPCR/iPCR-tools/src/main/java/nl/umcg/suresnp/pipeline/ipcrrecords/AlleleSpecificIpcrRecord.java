...
public class AlleleSpecificIpcrRecord extends IpcrRecord {
    ...
    public AlleleSpecificIpcrRecord(String barcode, String readAllele, String alternativeAllele, int variantStartInRead, GeneticVariant geneticVariant, SAMRecord primarySamRecord, VariantType variantType) {
