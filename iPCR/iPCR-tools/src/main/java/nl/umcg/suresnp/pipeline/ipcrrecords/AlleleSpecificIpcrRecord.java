...
public class AlleleSpecificIpcrRecord {
    ...
    public AlleleSpecificIpcrRecord(String barcode, String readAllele, String alternativeAllele, int variantStartInRead, GeneticVariant geneticVariant, SAMRecord record, VariantType variantType) {
