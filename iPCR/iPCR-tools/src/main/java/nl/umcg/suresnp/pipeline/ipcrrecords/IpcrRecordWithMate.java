...
public class IpcrRecordWithMate implements Comparable {
    ...
    public IpcrRecordWithMate(String barcode, SAMRecord cachedSamRecord, SAMRecord mate) {
        SAMRecord first;
        SAMRecord second;
        char strand;
    ...
    public IpcrRecordWithMate(String barcode, String referenceSequence, int startOne, int endOne, int startTwo, int endTwo, char orientation, int mapqOne, int mapqTwo, String cigarOne, String cigarTwo, String sequenceOne, String sequenceTwo, int duplicateCount) {
        this.barcode = barcode;
    ...
    public int compareTo(Object o) {
        IpcrRecordWithMate other = (IpcrRecordWithMate) o;
