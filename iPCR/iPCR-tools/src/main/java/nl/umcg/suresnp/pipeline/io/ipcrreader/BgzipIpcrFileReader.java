...
public class BgzipIpcrFileReader extends IpcrFileReader implements IpcrRecordProvider  {


    private static final Logger LOGGER = Logger.getLogger(BgzipIpcrFileReader.class);
    ...
    public BgzipIpcrFileReader(boolean hasHeader) {
        this.sep = "\t";
