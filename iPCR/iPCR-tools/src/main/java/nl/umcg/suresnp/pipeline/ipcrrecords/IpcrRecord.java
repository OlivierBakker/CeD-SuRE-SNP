...
public class IpcrRecord implements Comparable {
    ...
    public IpcrRecord(String barcode, Map<String, Integer> barcodeCount, SAMRecord cachedSamRecord, SAMRecord mate) {
        SAMRecord first;
        SAMRecord second;
        char strand;
    ...
    public IpcrRecord(String barcode, int barcodeCount, String referenceSequence, int startOne, int endOne, int startTwo, int endTwo, char orientation, int mapqOne, int mapqTwo, String cigarOne, String cigarTwo, String sequenceOne, String sequenceTwo, int duplicateCount) {
        this.barcode = barcode;
