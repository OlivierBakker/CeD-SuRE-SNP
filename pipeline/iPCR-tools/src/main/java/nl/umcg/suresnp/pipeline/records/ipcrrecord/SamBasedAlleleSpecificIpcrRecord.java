...
@Deprecated
public class SamBasedAlleleSpecificIpcrRecord extends SamBasedIpcrRecord {
    ...
    public SamBasedAlleleSpecificIpcrRecord(String barcode, String readAllele, String alternativeAllele, int variantStartInRead, GeneticVariant geneticVariant, SAMRecord primarySamRecord, VariantType variantType) {
